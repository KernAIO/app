...
- Decision:
  ...
  2. Every backend service is an instance of the same runtime (`@kernhq/kernel`) hosting a configured list of modules. Which module runs where is configuration, not code.
