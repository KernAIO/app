...
- **Collaborative documents**: a second, independent realtime path. Page prose is a Yjs document synchronised through `collab`; the tree, spaces and everything else are ordinary rows. The two look alike and are unrelated. See [ADR 0006](adr/0006-collaborative-documents.md).
