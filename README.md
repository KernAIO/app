...
| [`kernel`](https://github.com/KernAIO/kernel) | `@kernhq/kernel`, `@kernhq/contracts`, `@kernhq/ui`, `@kernhq/sdk` |
| [`modules`](https://github.com/KernAIO/modules) | first-party modules (`@kernhq/module-*`) |
...
pnpm setup        # clones every repo into ./repos and installs deps (pnpm links @kernhq/* locally)
...
```
Each repo also works standalone (`pnpm i && pnpm dev`) using published `@kernhq/*` packages.
